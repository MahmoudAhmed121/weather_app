...
import 'package:weather_app/core/utils/constant/app_color.dart';
...
class CustomTextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      child: TextButton(
        ...
        child: FittedBox(
          child: Row(
            children: [
              if (activeIconImage!) ...[
                SvgPicture.asset(iconImage!, width: 25.w, height: 25.h),
                SizedBox(width: 10.w),
              ],
              Text(
    ...
    return isLoading
        ? SizedBox(height: 45, child: TextButtonLoading)
